...
v0.4 Step 3: Ctrl+C now exits gracefully with a friendly message and a
final save, instead of printing a traceback. The normal 'exit'/'quit'
flow is unchanged.
"""
...
def main():
    ...
    while True:
        try:
            ...
            print()
            print("Thanks for chatting with RobiDev AI.")
